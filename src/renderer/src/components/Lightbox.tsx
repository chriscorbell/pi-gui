  ...
  return (
    <div className={cn("group relative shrink-0 overflow-hidden rounded-md border border-border", className)} style={{ width: size, height: size }}>
      <button
        ...
        className="block h-full w-full cursor-zoom-in transition-transform duration-150 ease-out hover:scale-[1.04] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
      >
